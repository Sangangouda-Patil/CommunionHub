      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Contact Info Card */}
            <motion.div
              className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 md:p-8 lg:p-10 h-fit"
            ...
            <motion.div
              className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 md:p-8 lg:p-10 lg:col-span-2"
              variants={itemVariants}
            >
              <ContactForm />
            </motion.div>
